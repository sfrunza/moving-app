...
class MovingResult extends Component {
  ...
  returnFunction(movers, rate, time){
    return(
      ...
      <TableBody>
        <TableRow selected>
          <TableCell style={{width: '52%'}}>Crew</TableCell>
          <TableCell>
            {movers} Movers
          </TableCell>
        </TableRow>
        ...
        <TableRow >
          <TableCell style={{width: '52%'}}>Rate</TableCell>
          <TableCell>
            <label>$ {rate}</label> / hour
          </TableCell>
        </TableRow>

        <TableRow selected>
          <TableCell style={{width: '52%'}}>Estimate job time</TableCell>
          <TableCell>
        ...
        <TableRow >
          <TableCell style={{width: '52%'}}>Estimated Quote</TableCell>
          <TableCell>
