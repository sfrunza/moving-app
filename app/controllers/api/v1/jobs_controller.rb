module Api::V1
  class JobsController < ApplicationController
    ...
    private
      ...
      def job_params
        params.require(:job).permit(:pick_up_date, :delivery_date, :is_flat_rate, :job_duration, :job_size, :job_status, :start_time, :crew_size, :job_rate, :estimated_time, :travel_time, :time_between, :estimated_quote, :additional_info, :total_amount, :job_type, :customer_id, user_ids: [])
      end
  end
end
